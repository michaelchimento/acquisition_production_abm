...
for (i in unique(df_EWA$grouping)){
  ...
  #fit model in stan
  fit <- stan( file = 'stan_code/stan_model_noRE_phisigma_preprogrammed.stan', data = ds ,
               iter = 2500, warmup=1000, chains=3, cores=5, pars=parlist,
...
df_diffusion = data
save(df_diffusion,file="../model_outputs/Rda_files/df_social_inference_preprogrammed.Rda")
...
save(df_asocial_inference,file="../model_outputs/Rda_files/df_asocial_inference_preprogrammed.Rda")
