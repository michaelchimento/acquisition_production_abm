...
### NBDA parameters ###
NBDA_type = 3 # 0: Unbounded general form; 1: bounded, linked S and (1-S);
f_T_values = [1,2]
s_param_values = [10,20,30] #s parameter from NBDA indicating strength of social learning per unit of connection
...
f_P_values = [1,2] #conformity exponent EWA values
tau_values = [1] #sensitivity to differences in payoffs
memory_window_values = [1,5,10,20] #how far back the agent can remember (in time steps) the behaviors that other agents produce

behavior_names = ["a","b"]
behavior_payoffs = [1,1]

#output file placement bookkeeping
condition_name = "GENERATIVE_memory_conformity"
