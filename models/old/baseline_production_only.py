...
### NBDA parameters ###
f_T_values = [1]
s_param_values = [1] #s parameter from NBDA indicating strength of social learning per unit of connection
...
asocial_learning_values = [False] #True or false, depending on if asocial learning occurs
...
rho_values = [0.01,0.5,0.99]#np.around(np.arange(0.1, 1.1, 0.4), 1) #recent payoff bias EWA values
chi_values = [.75,1,3] #conformity exponent EWA values
...
condition_name = "BASELINE_production"
