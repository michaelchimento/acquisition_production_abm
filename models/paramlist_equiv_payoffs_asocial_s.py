...
f_SL_values = [1,2]
s_param_values = [25,50,100] #s parameter from NBDA indicating strength of social learning per unit of connection
...
file_name = "equiv_payoffs_asocial_sparam.csv"
